...
2. 令 $x= \begin{bmatrix} x_0\\x_1\\x_2\\\vdots\\x_n \end{bmatrix} $ $\theta=\left[\begin{matrix} \theta_0\\\theta_1\\\theta_2\\\vdots\\\theta_n \end{matrix}\right]$ ，则 $\begin{align*}h_\theta(x) =\begin{bmatrix}\theta_0 \hspace{2em} \theta_1 \hspace{2em} ... \hspace{2em} \theta_n\end{bmatrix}\begin{bmatrix}x_0 \newline x_1 \newline \vdots \newline x_n\end{bmatrix}= \theta^T x\end{align*}$
...
**Prediction:** $h_\theta(x)=\theta_0+\theta_1x_1+\theta_2x_2+\cdots+\theta_nx_n =  \theta^T x$
...
$x_1=\frac{x_1-\mu_1}{s_1}$  其中$\mu_1$是$x_1$的平均值$\frac{\sum ^n _{i=1} {x_i}}{n}$
